...
/**
 * Person que puede ser Administrador de un restaurante o un cliente de la aplicacion 
 * 
...
public class Person 
{
    ...
    /**
     * Tipo de Person (Administrador o Usuario)
     */
    private String atrType;

    public Person(){}

    public Person(String atrUserName, String atrIdentification, String atrName, String atrLastName, String atrContrasena, String atrCiudad, String atrDireccion, String atrCelular, String atrTipo) {
